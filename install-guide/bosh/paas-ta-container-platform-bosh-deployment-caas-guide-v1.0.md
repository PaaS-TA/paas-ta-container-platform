...
- 서비스 설치에 필요한 릴리스 파일을 다운로드 받아 Local machine의 서비스 설치 작업 경로로 위치시킨다.  
  + 설치 릴리즈 파일 다운로드 :  
  [paasta-container-platform-svc-1.0.tgz](http://45.248.73.44/index.php/s/Ymqr49Z7ggm9R7A/download)   
...
$ wget --content-disposition http://45.248.73.44/index.php/s/Ymqr49Z7ggm9R7A/download
