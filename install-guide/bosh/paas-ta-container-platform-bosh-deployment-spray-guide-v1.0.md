...
+ 컨테이너 플랫폼 이미지 파일 다운로드 :  
   [cp-standalone-images.tar](https://nextcloud.paas-ta.org/index.php/s/zYZTBrdPKjRkNP3/download)  
...
$ wget --content-disposition https://nextcloud.paas-ta.org/index.php/s/zYZTBrdPKjRkNP3/download
