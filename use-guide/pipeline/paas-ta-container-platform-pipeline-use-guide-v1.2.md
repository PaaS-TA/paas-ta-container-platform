...
# [PaaS-TA Container Platform 배포 파이프라인 사용자 가이드]
...
## <div id='1-1'/> 1.1 목적
본 문서는 컨테이너 플랫폼 배포 파이프라인 서비스를 사용할 사용자의 사용 방법에 대해 기술하였다.

## <div id='1-2'/> 1.2 범위
본 문서는 Windows 환경을 기준으로 컨테이너 플랫폼 배포 파이프라인 서비스를 사용할 사용자의 사용 방법에 대해 작성되었다.
